...
ITEM_STATUS_CANCELLED_ITEM = "Item Cancelled" # Specific to item line cancellation within an indent
...
ALL_PO_STATUSES = [
    ...
    PO_STATUS_FULLY_RECEIVED, PO_STATUS_CANCELLED_PO
]
...
FILTER_ALL_SUBCATEGORIES = "All Sub-Categories" # For sub-category filters (e.g., in 1_Items.py)
...
PLACEHOLDER_NO_ITEMS_AVAILABLE = "No items available" # General placeholder if item master is empty
