...
# Ensure an environ.Env() is available in this module
try:
...
MIDDLEWARE = [
    ...
    # Removed custom performance middleware to avoid ImportError in production
...
# Production allowed hosts - configured from env and platform defaults
...
if "DJANGO_ALLOWED_HOSTS" in os.environ:
    ...
    ALLOWED_HOSTS.extend([h for h in hosts if h])

# Allow Render’s autogenerated hostname
RENDER_EXTERNAL_HOSTNAME = os.environ.get("RENDER_EXTERNAL_HOSTNAME")
if RENDER_EXTERNAL_HOSTNAME:
    ALLOWED_HOSTS.append(RENDER_EXTERNAL_HOSTNAME)

# As a last resort, allow all to keep the app booting (tighten in your env)
