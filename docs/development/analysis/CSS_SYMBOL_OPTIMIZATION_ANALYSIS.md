...
.btn-primary { /* defined twice with slight variations */ }
.nav-link { /* multiple definitions */ }
.table { /* conflicting table styles */ }
```
...
<span class="text-sm">📊</span>Reports
<span class="text-sm">📦</span>Items
