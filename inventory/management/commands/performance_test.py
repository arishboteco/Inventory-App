...
class Command(BaseCommand):
    ...
    def handle(self, *args, **options):
        ...
        self.stdout.write(f'🚀 Starting performance benchmarks ({iterations} iterations each)...\n')
        ...
        for i in range(iterations):
            ...
            request.user = user
            response = history_reports(request)
        ...
        self.stdout.write(f'   Total Stock Transactions: {StockTransaction.objects.count()}')
        ...
        self.stdout.write(f'   Overall Average Query Count: {total_avg_queries:.1f} queries')
        ...
        if total_avg_queries > 15:
            ...
            self.stdout.write('   - Use select_related/prefetch_related for relationships')
