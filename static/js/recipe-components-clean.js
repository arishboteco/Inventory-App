(function() {
  ...
  function initRecipeComponentsTable() {
    ...
    // Find elements
    var table = document.querySelector('#recipe-components-formset table') || document.querySelector('#items-table');
    var tbody = table ? table.querySelector('tbody') : null;
    var totalForms = document.querySelector('input[name$="TOTAL_FORMS"]');
    var emptyRow = document.querySelector('tr.form-row.hidden') || document.querySelector('#items-empty-row');
