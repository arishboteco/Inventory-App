...
#### **Security Variables:**
```bash
DJANGO_SECRET_KEY=your-super-secure-secret-key-here-at-least-50-chars
...
2. Update `DJANGO_ALLOWED_HOSTS` to include your domain:
   ```bash
   DJANGO_ALLOWED_HOSTS=your-app-name.onrender.com,yourdomain.com,www.yourdomain.com
   ```
